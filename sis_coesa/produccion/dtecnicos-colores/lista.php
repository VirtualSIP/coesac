...
//DATOS TECNICOS
$rst_colores=mysql_query("SELECT * FROM syCoesa_datos_tecnicos_colores ORDER BY id_colores ASC;", $conexion);
        ...
        <div id="datos_colores">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera">
                <h6>Datos Técnicos Colores - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
						...
						?>
                        <tr>
                            <td align="center"><?php echo $colores_nombre; ?></td>
                            <td class="center">
                            	<a href="form-editar.php?id=<?php echo $colores_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $colores_id ?>, '<?php echo $colores_nombre; ?>');" href="javascript:;">
