    ...
    <section id="contenido">
        ...
        <div id="datos_colores">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Datos Técnicos Colores</h6></div>
                ...
                <div class="frmdt_contenido">
                  ...
                  <form action="guardar.php" method="post">
                    ...
                    <fieldset class="alto50">
                        <label for="colores_nombre">Nombre:</label>
                      <span id="spry_colores_nombre">
                        <input type="text" name="colores_nombre" id="colores_nombre" size="50" class="an50">
                    ...
                    <fieldset class="alto50">
                      ...
                      <input type="text" name="colores_cuerpo_impresor" id="colores_cuerpo_impresor" size="50" class="an50">
                      <span class="textfieldRequiredMsg">(*)</span></span>
                    </fieldset>
                    ...
                    <fieldset class="alto50">
                        ...
                        <input type="text" name="colores_cilindro" id="colores_cilindro" size="50" class="an50">
                        <span class="textfieldRequiredMsg">(*)</span></span>
                    </fieldset>
                    ...
                    <fieldset class="alto50">
                      ...
                      <input type="text" name="colores_anilox" id="colores_anilox" size="50" class="an50">
                      <span class="textfieldRequiredMsg">(*)</span></span>
                    </fieldset>
                    ...
                    <fieldset class="alto50">
                      ...
                      <span id="spry_colores_viscocidad">
                            <input type="text" name="colores_viscocidad" id="colores_viscocidad" size="50" class="an50">
                            <span class="textfieldRequiredMsg">(*)</span></span>
                    </fieldset>
                    ...
                    <fieldset class="alto50">
                            ...
                            <input type="text" name="colores_area_impresa" id="colores_area_impresa" size="50" class="an50">
                            <span class="textfieldRequiredMsg">(*)</span></span>
                    </fieldset>
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("spry_colores_nombre");
