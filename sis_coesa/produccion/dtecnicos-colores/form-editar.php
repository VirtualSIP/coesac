    ...
    <section id="contenido">
        ...
        <div id="datos_colores">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Datos Técnicos Colores | ID: <?php echo $colores_id; ?></h6></div>
                ...
                <div class="frmdt_contenido">
                  ...
                  <form action="actualizar.php" method="post">
                        ...
                        <fieldset class="alto50">
                            ...
                            <input type="text" name="colores_nombre" id="colores_nombre" size="50" class="an50" value="<?php echo $colores_nombre; ?>">
