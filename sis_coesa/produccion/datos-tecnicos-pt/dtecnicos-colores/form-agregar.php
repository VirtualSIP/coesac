...
$id_dt_tecnico=$_REQUEST["did"];
$dt_accion=$_REQUEST["ac"];

//DATOS TECNICOS
$rst_dtecnicos=mysql_query("SELECT * FROM syCoesa_datos_tecnicos WHERE id_datos_tecnicos=$id_dt_tecnico;", $conexion);
$fila_dtecnicos=mysql_fetch_array($rst_dtecnicos);

//DATOS TECNICOS - VARIABLES
$dtecnicos_id=$fila_dtecnicos["id_datos_tecnicos"];

if($dt_accion=="add"){ $dtecnicos_ctdcolores=1;}
else{ $dtecnicos_ctdcolores=$fila_dtecnicos["nro_colores_datos_tecnicos"]; }
        ...
        <div id="datos_colores">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera">
                <h6>Datos Tecnicos Producción</h6></div>
            
                <div class="frmdt_contenido">
                    
                  <form action="guardar.php" method="post">
                  
                  <?php for($i=1;$i<=$dtecnicos_ctdcolores;$i++){ ?>
                  
                  <?php
				  	$rst_art_tintas=mysql_query("SELECT * FROM syCoesa_articulo WHERE id_tipo_articulo=2 AND producto_terminado='I' ORDER BY nombre_articulo ASC;", $conexion); //TINTAS
					$rst_art_cushion=mysql_query("SELECT * FROM syCoesa_articulo WHERE id_tipo_articulo=7 AND producto_terminado='I' ORDER BY nombre_articulo ASC;", $conexion); //CUSHION
					$rst_art_stickback=mysql_query("SELECT * FROM syCoesa_articulo WHERE id_tipo_articulo=8 AND producto_terminado='I' ORDER BY nombre_articulo ASC;", $conexion); //STICK BACK
				  ?>
                   ...
                   <?php } ?>
                    ...
                    <fieldset>
                        ...
                        <input name="datos_tecnicos" type="hidden" value="<?php echo $dtecnicos_id; ?>">
                        <input name="colores_cantidad" type="hidden" value="<?php echo $dtecnicos_ctdcolores; ?>">
                    </fieldset>
