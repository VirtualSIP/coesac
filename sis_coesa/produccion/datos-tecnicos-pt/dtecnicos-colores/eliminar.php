...
mysql_query("UPDATE syCoesa_datos_tecnicos SET estado_datos_tecnicos='$colores_estado', nro_colores_datos_tecnicos=$cantidad_colores WHERE id_datos_tecnicos=$colores_did;", $conexion);
