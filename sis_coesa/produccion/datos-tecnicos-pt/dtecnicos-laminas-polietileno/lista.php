...
//DATOS TECNICOS
$rst_laminas=mysql_query("SELECT * FROM syCoesa_datos_tecnicos_laminas_polietileno WHERE id_datos_tecnicos=$did ORDER BY id_lamina_polietileno ASC;", $conexion);
