...
//USUARIO
$rst_usuario=mysql_query("SELECT * FROM syCoesa_usuario ORDER BY usuario DESC;", $conexion);
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_usuario=mysql_fetch_array($rst_usuario)){
							$dtusuario_id=$fila_usuario["usuario"];
							$dtusuario_nombre=$fila_usuario["nombre"];
							$dtusuario_apellidos=$fila_usuario["apellidos"];
							$dtusuario_acceso=$fila_usuario["tipo_acceso"];
							$dtusuario_estado=$fila_usuario["estadoErrorSession"];
							$dtusuario_priv=seleccionTabla($dtusuario_acceso, "id_usuario_tipo", "syCoesa_usuario_tipo", $conexion);
						?>
                        <tr>
                            <td><?php echo $dtusuario_nombre." ".$dtusuario_apellidos; ?></td>
                            <td class="center"><?php echo $dtusuario_id; ?></td>
                            <td class="center"><?php echo $dtusuario_priv["usuario_tipo"]; ?></td>
                            <td class="center">
                            	<?php if($dtusuario_estado=="A"){ ?>
                            	<img src="/imagenes/icons/icon-user-activo.png" width="16" height="16" alt="Usuario" title="Usuario activo">
                                <?php }elseif($dtusuario_estado=="I"){ ?>
                                <img src="/imagenes/icons/icon-user-inactivo.png" width="16" height="16" alt="Usuario" title="Usuario bloqueado">
                                <?php } ?>
                            	&nbsp;
                            	<a href="form-editar.php?usr=<?php echo $dtusuario_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro('<?php echo $dtusuario_id ?>', '<?php echo $dtusuario_nombre." ".$dtusuario_apellidos; ?>');" href="javascript:;">
