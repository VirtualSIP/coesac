...
//TIPO DE USUARIO
$rst_userTipo=mysql_query("SELECT * FROM syCoesa_usuario_tipo WHERE id_usuario_tipo=$id_usuario;", $conexion);
$fila_userTipo=mysql_fetch_array($rst_userTipo);

$userTipo_nombre=$fila_userTipo["usuario_tipo"];
$userTipo_obs=$fila_userTipo["observaciones"];
                ...
                <div class="frmdt_contenido">
                  ...
                  <form action="actualizar.php" method="post">
                    	...
                    	<fieldset class="alto50">
                            ...
                            <input type="text" name="usuario_nombre" id="usuario_nombre" size="50" value="<?php echo $userTipo_nombre; ?>">
                        </fieldset>
                        
                        <fieldset>
                        	<label for="almart_observaciones">Observaciones:</label>
                        	<textarea name="observaciones" id="observaciones" cols="" rows=""><?php echo $userTipo_obs; ?></textarea>
                        </fieldset>
