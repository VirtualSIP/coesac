    ...
    <section id="contenido">
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Cilindros - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
						...
						?>
                        <tr>
                            <td class="center"><?php echo $cilindro_nombre; ?></td>
                            <td class="center">
                            	<a href="form-editar.php?id=<?php echo $cilindro_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $cilindro_id ?>, '<?php echo $cilindro_nombre; ?>');" href="javascript:;">
