...
//ARTICULOS
$rst_proceso=mysql_query("SELECT * FROM syCoesa_mantenimiento_procesos_productivos ORDER BY orden_proceso ASC;", $conexion);
    ...
    <section id="contenido">
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Procesos - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_proceso=mysql_fetch_array($rst_proceso)){
							$proceso_id=$fila_proceso["id_proceso"];
							$proceso_nombre=$fila_proceso["nombre_proceso"];
						?>
                        <tr>
                            <td class="center"><?php echo $proceso_nombre; ?></td>
                            <td class="center">
                                ...
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $proceso_id ?>, '<?php echo $proceso_nombre; ?>');" href="javascript:;">
