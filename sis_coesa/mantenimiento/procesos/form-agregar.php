    ...
    <section id="contenido">
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Procesos</h6></div>
                  ...
                  <form action="guardar.php" method="post">
                        ...
                        <fieldset class="alto50">
                          ...
                          <span id="spry_proceso_nombre">
                            <input type="text" name="proceso_nombre" id="proceso_nombre" size="50">
                            <span class="textfieldRequiredMsg">(*)</span></span>
                        </fieldset>
                        
                        <fieldset class="alto50">
                            <label for="merma_permitida">% Mema permitida:</label>
                            <input name="merma_permitida" type="text" class="w140 texto_der" id="merma_permitida" value="0" size="50">
                        </fieldset>
                        
                        <fieldset class="alto50">
                            <label for="merma_tipo">Tipo de merma:</label>
                            <input name="merma_tipo" type="text" class="w140 texto_der" id="merma_tipo" size="50">
                        </fieldset>
                        
                        <fieldset class="alto50">
                            <label for="orden">Orden:</label>
                            <input name="orden" type="text" class="w140 texto_der" id="orden" size="50">
                        </fieldset>
                        
                        <fieldset>
                            <label for="proceso_observaciones">Observaciones:</label>
                            <textarea name="proceso_observaciones" cols="100" rows="8" id="proceso_observaciones"></textarea>
                        </fieldset>
