                  ...
                  <form action="guardar.php" method="post">
                        ...
                        <fieldset class="alto50">
                          ...
                          <span id="spry_nombre_unidad_medida">
                            <input type="text" name="nombre_unidad_medida" id="nombre_unidad_medida" size="50">
                        ...
                        <fieldset class="alto50">
                          ...
                          <input type="text" name="factor_conversion_unidad_medida" id="factor_conversion_unidad_medida" size="50" class="an50">
