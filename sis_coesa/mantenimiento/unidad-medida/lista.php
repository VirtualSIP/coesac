...
//ARTICULOS
$rst_articulos=mysql_query("SELECT * FROM syCoesa_unidad_medida ORDER BY id_unidad_medida ASC;", $conexion);
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera">
                <h6>Unidad de Medida - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    <thead>
                        <tr>
                            ...
                            <th width="25%">Factor  Conversión</th>
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_articulos=mysql_fetch_array($rst_articulos)){
							$unidad_medida_id=$fila_articulos["id_unidad_medida"];
							$unidad_medida_nombre=$fila_articulos["nombre_unidad_medida"];
							$unidad_medida_factor_conversion=$fila_articulos["factor_conversion_unidad_medida"];
						?>
                        <tr>
                            <td><?php echo $unidad_medida_nombre; ?></td>
                            <td class="center"><?php echo $unidad_medida_factor_conversion; ?></td>
                            <td class="center">
                            	<a href="form-editar.php?id=<?php echo $unidad_medida_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $unidad_medida_id ?>, '<?php echo $unidad_medida_nombre; ?>');" href="javascript:;">
