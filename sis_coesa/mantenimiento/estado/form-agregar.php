    ...
    <section id="contenido">
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Estado</h6></div>
                ...
                <div class="frmdt_contenido">
                  ...
                  <form action="guardar.php" method="post">
                        ...
                        <fieldset class="alto50">
                          ...
                          <span id="spry_estado_nombre">
                            <input type="text" name="estado_nombre" id="estado_nombre" size="50">
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("spry_estado_nombre");
</script>
</body>
</html>