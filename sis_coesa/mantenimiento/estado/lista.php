...
//ARTICULOS
$rst_estados=mysql_query("SELECT * FROM syCoesa_mantenimiento_estado ORDER BY id_estado ASC;", $conexion);
    ...
    <section id="contenido">
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Estado - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_estados=mysql_fetch_array($rst_estados)){
							$estados_id=$fila_estados["id_estado"];
							$estados_nombre=$fila_estados["nombre_estado"];
						?>
                        <tr>
                            <td class="center"><?php echo $estados_nombre; ?></td>
                            <td class="center">
                            	<a href="form-editar.php?id=<?php echo $estados_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $estados_id ?>, '<?php echo $estados_nombre; ?>');" href="javascript:;">
