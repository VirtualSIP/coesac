...
//ARTICULOS
$rst_maquinas=mysql_query("SELECT * FROM syCoesa_mantenimiento_maquinas_tipo ORDER BY id_tipo_maquina ASC;", $conexion);
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera">
                <h6>Tipo de Máquina - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_maquinas=mysql_fetch_array($rst_maquinas)){
							$maquinas_id=$fila_maquinas["id_tipo_maquina"];
							$maquinas_nombre=$fila_maquinas["nombre_tipo_maquina"];
						?>
                        <tr>
