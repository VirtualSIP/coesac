...
//ARTICULOS
$rst_maquinas=mysql_query("SELECT * FROM syCoesa_mantenimiento_maquinas ORDER BY id_maquina ASC;", $conexion);
    ...
    <section id="contenido">
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Maestro Máquinas - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_maquinas=mysql_fetch_array($rst_maquinas)){
							$maquinas_id=$fila_maquinas["id_maquina"];
							$maquinas_nombre=$fila_maquinas["nombre_maquina"];
						?>
                        <tr>
                            <td class="center"><?php echo $maquinas_nombre; ?></td>
                            <td class="center">
                            	<a href="form-editar.php?id=<?php echo $maquinas_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $maquinas_id ?>, '<?php echo $maquinas_nombre; ?>');" href="javascript:;">
