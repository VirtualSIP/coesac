...
//ARTICULOS
$rst_articulos=mysql_query("SELECT * FROM syCoesa_articulo_tipo ORDER BY id_tipo_articulo DESC;", $conexion);
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera">
                <h6>Tipo de Articulos - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_articulos=mysql_fetch_array($rst_articulos)){
							$tipo_articulo_id=$fila_articulos["id_tipo_articulo"];
							$tipo_articulo_nombre=$fila_articulos["nombre_tipo_articulo"];
							$tipo_articulo_abreviado=$fila_articulos["abreviado_tipo_articulo"];
						?>
                        <tr>
                            <td><?php echo $tipo_articulo_nombre; ?></td>
                            <td class="center"><?php echo $tipo_articulo_abreviado; ?></td>
                            <td class="center">
                            	<a href="form-editar.php?id=<?php echo $tipo_articulo_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $tipo_articulo_id ?>, '<?php echo $tipo_articulo_nombre; ?>');" href="javascript:;">
