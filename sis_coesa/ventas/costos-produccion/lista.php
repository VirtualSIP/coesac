...
//DATOS TECNICOS
$rst_cproduccion=mysql_query("SELECT * FROM syCoesa_costo_produccion ORDER BY id_costo_produccion DESC;", $conexion);
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera">
                <h6>Costos de Producción - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_cproduccion=mysql_fetch_array($rst_cproduccion)){
						...
						?>
                        <tr>
                            <td align="center"><?php echo $cproduccion_articulo["nombre_articulo"]; ?></td>
                            <td class="center"><?php echo $cproduccion_cliente["nombre_cliente"]; ?></td>
                          	<td class="center">
                            	<a href="form-editar.php?id=<?php echo $cproduccion_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $cproduccion_id; ?>, '<?php echo $cproduccion_cliente["nombre_cliente"]; ?>');" href="javascript:;" title="Eliminar registro">
                              	<img src="/imagenes/icons/icon-eliminar.png" width="20" height="20" alt="Eliminar"></a>
                                &nbsp;
                                <a href="impresion.php?imp=<?php echo $cproduccion_id; ?>" target="_blank" title="Imprimir">
