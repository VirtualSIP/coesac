...
//DATOS TECNICOS
$rst_colores=mysql_query("SELECT * FROM syCoesa_datos_tecnicos_colores WHERE id_articulo=$id_articulo ORDER BY cuerpo_impresor_colores ASC;", $conexion);
                                    ...
                                    <li id="listItem_<?php echo $colores_id; ?>" class="alto">
                                    	<table class="tabla_colores">
                                          <tr align="center">
                                            ...
                                            <td width="11%" height="45px">
                                            	<a href="form-modificar.php?id=<?php echo $colores_id; ?>&amp;dart=<?php echo $colores_articulo; ?>">
                                        		<img src="/imagenes/icons/icon-editar.png" width="20" height="20" /></a>
                                            </td>
                                          </tr>
                                        </table>
                                    </li>
