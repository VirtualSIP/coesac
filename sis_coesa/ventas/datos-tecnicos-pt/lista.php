              ...
              <div class="frmdt_cabecera">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
						...
						?>
                        <tr>
                            <td class="left"><?php echo $dtecnicos_cliente["nombre_cliente"]; ?></td>
                            <td class="left"><?php echo $dtecnicos_articulo["nombre_articulo"]; ?></td>
                          	<td class="center">
                                ...
                                <a href="dtecnicos-laminas/lista.php?did=<?php echo $dtecnicos_id; ?>&dart=<?php echo $dtecnicos_articulo["id_articulo"]; ?>&clt=<?php echo $dtecnicos_cliente["id_cliente"]; ?>" title="Laminas">
                              	<img src="/imagenes/icons/icon-lamina.png" width="20" height="18" alt="Laminas"></a>
                            </td>
                        </tr>
                        <?php } ?>
