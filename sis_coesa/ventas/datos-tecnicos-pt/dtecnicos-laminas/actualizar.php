...
$rst_guardar=mysql_query("UPDATE syCoesa_datos_tecnicos_laminas_procesos SET id_articulo_prin=$dart, 
	...
	lamina1_bilaminado=$lamina1_bilaminado,
	lamina1_trilaminado=$lamina1_trilaminado,
	lamina1_rebobinado=$lamina1_rebobinado,
	lamina1_habilitado=$lamina1_habilitado,
	lamina1_cortefinal=$lamina1_cortefinal,
	lamina1_sellado=$lamina1_sellado,
	lamina2=$lamina2,
	lamina2_extrusion=$lamina2_extrusion,
	lamina2_impresion=$lamina2_impresion,
	lamina2_bilaminado=$lamina2_bilaminado,
	lamina2_bilaminado_grm2=$lamina2_bilaminado_grm2,
	lamina2_trilaminado=$lamina2_trilaminado,
	lamina2_rebobinado=$lamina2_rebobinado,
	lamina2_habilitado=$lamina2_habilitado,
	lamina2_cortefinal=$lamina2_cortefinal,
	lamina2_sellado=$lamina2_sellado,
	lamina3=$lamina3,
	lamina3_extrusion=$lamina3_extrusion,
	lamina3_impresion=$lamina3_impresion,
	lamina3_bilaminado=$lamina3_bilaminado,
	lamina3_trilaminado=$lamina3_trilaminado,
	lamina3_trilaminado_grm2=$lamina3_trilaminado_grm2,
	lamina3_rebobinado=$lamina3_rebobinado,
	lamina3_habilitado=$lamina3_habilitado,
	lamina3_cortefinal=$lamina3_cortefinal,
	lamina3_sellado=$lamina3_sellado WHERE id_laminas_procesos=$id_registro;", $conexion);
...
if (mysql_errno()!=0){
	...
	mysql_close($conexion);
	header("Location:lista.php?did=$did&dart=$dart&clt=$clt&m=2");
}
