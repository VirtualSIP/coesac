...
//DATOS TECNICOS
$rst_procesos=mysql_query("SELECT * FROM syCoesa_datos_tecnicos_procesos ORDER BY id_proceso ASC;", $conexion);
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera">
                <h6>Datos Técnicos Procesos - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    <thead>
                        <tr>
                            <th width="85%">Maquina</th>
                            <th width="15%">Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                    
                    	<?php while($fila_procesos=mysql_fetch_array($rst_procesos)){
							$proceso_id=$fila_procesos["id_proceso"];
							$proceso_maquina=seleccionTabla($fila_procesos["id_maquina"], "id_maquina", "syCoesa_mantenimiento_maquinas", $conexion);
						?>
                        <tr>
                            <td align="center"><?php echo $proceso_maquina["nombre_maquina"]; ?></td>
                            <td class="center">
                            	<a href="form-editar.php?id=<?php echo $proceso_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $proceso_id ?>, '<?php echo $proceso_maquina["nombre_maquina"]; ?>');" href="javascript:;">
