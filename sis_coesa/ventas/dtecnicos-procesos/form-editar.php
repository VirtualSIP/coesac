...
//PEDIDO
$rst_procesos=mysql_query("SELECT * FROM syCoesa_datos_tecnicos_procesos WHERE id_proceso=$id_registro;", $conexion);
$fila_procesos=mysql_fetch_array($rst_procesos);
$num_procesos=mysql_num_rows($rst_procesos);
if($num_procesos==0){ header("Location:lista.php"); }

//ARTICULOS - VARIABLES
$procesos_id=$fila_procesos["id_proceso"];
$procesos_maquina=$fila_procesos["id_maquina"];
$procesos_grm2=$fila_procesos["grm2_proceso"];
$procesos_velocidad=$fila_procesos["velocidad_proceso"];
    ...
    <section id="contenido">
        ...
        <div id="datos_procesos">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Datos Técnicos Procesos | ID: <?php echo $procesos_id; ?></h6></div>
                ...
                <div class="frmdt_contenido">
                  ...
                  <form action="actualizar.php" method="post">
                        ...
                        <fieldset class="alto50">
                          <label for="procesos_maquina">Maquina:</label>
                          ...
                          <select name="procesos_maquina" id="procesos_maquina">
                              <option value>[ Seleccionar opcion ]</option>
								...
								?>
								<?php if ($procesos_maquina==$maquina_id){ ?>
                                 	<option selected='' value=<?php echo $maquina_id; ?>><?php echo $maquina_nombre; ?></option>
                                <?php }else{ ?>
                        ...
                        <fieldset class="alto50">
                          ...
                          <input name="procesos_grm2" type="text" class="an50" id="procesos_grm2" value="<?php echo $procesos_grm2; ?>" size="50">
                        ...
                        <fieldset class="alto50">
                          ...
                          <input name="procesos_velocidad" type="text" class="an50" id="procesos_velocidad" value="<?php echo $procesos_velocidad; ?>" size="50">
                          <span class="textfieldRequiredMsg">(*)</span>
                          <span class="textfieldInvalidFormatMsg">(*)</span></span>
                        </fieldset>
                    <fieldset>
                        	<input name="procesos_id" type="hidden" id="procesos_id" value="<?php echo $procesos_id; ?>">
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("spry_procesos_velocidad", "integer", {maxChars:50});
var sprytextfield2 = new Spry.Widget.ValidationTextField("spry_procesos_grm2", "real");
