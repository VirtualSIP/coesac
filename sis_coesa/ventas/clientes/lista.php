                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_clientes=mysql_fetch_array($rst_clientes)){
							$cliente_id=$fila_clientes["id_cliente"];
							$cliente_nombre=$fila_clientes["nombre_cliente"];
							$cliente_documento=$fila_clientes["documento_cliente"];
							$cliente_documento_tipo=$fila_clientes["documento_tipo_cliente"];							
						?>
                        <tr>
                            <td><?php echo $cliente_nombre; ?></td>
                            <td class="left"><?php echo $cliente_documento_tipo.": ".$cliente_documento; ?></td>
                            <td class="center">
                            	<a href="form-editar.php?id=<?php echo $cliente_id; ?>" title="Modificar Registro">
                                <img src="/imagenes/icons/icon-editar.png" width="20" height="20" alt="Editar"></a>
                                &nbsp;
                                <a onclick="eliminarRegistro(<?php echo $cliente_id; ?>, '<?php echo $cliente_nombre; ?>');" href="javascript:;">
