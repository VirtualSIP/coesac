    ...
    <section id="contenido">
        ...
        <div id="datos_laminas">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Datos Técnicos Láminas Polietileno</h6></div>
                ...
                <div class="frmdt_contenido">
                  ...
                  <form action="guardar.php" method="post">
                        ...
                        <fieldset class="alto50">
                          ...
                          <input type="text" name="laminas_mezcla" id="laminas_mezcla" size="50" class="an50">
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("spry_laminas_mezcla", "real");
var sprytextfield2 = new Spry.Widget.ValidationTextField("spry_laminas_calculo_kg", "real");
