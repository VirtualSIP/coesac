    ...
    <section id="contenido">
        ...
        <div id="datos_laminas">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Datos Técnicos Láminas</h6></div>
                ...
                <div class="frmdt_contenido">
                  ...
                  <form action="guardar.php" method="post">
                        ...
                        <fieldset class="alto50">
                          <label for="laminas_articulo">Articulos:</label>
                        ...
                        <fieldset class="alto50">
                            <label for="laminas_ancho">Ancho lamina:</label>
                          <span id="spry_laminas_ancho">
                          <input type="text" name="laminas_ancho" id="laminas_ancho" size="50" class="an50">
                        ...
                        <fieldset class="alto50">
                          ...
                          <input type="text" name="laminas_grm2" id="laminas_grm2" size="50" class="an50">
                          <span class="textfieldRequiredMsg">(*)</span>
                          <span class="textfieldInvalidFormatMsg">(*)</span></span>
                        </fieldset>
                    ...
                    <fieldset class="alto50">
                      ...
                      <input type="text" name="laminas_calculo_kg" id="laminas_calculo_kg" size="50" class="an50">
                      <span class="textfieldRequiredMsg">(*)</span>
                      <span class="textfieldInvalidFormatMsg">(*)</span></span>
                    </fieldset>
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("spry_laminas_ancho", "real");
var sprytextfield2 = new Spry.Widget.ValidationTextField("spry_laminas_grm2", "integer");
var sprytextfield3 = new Spry.Widget.ValidationTextField("spry_laminas_calculo_kg", "real");
