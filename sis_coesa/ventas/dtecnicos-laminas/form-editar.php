...
//LAMINAS
$rst_laminas=mysql_query("SELECT * FROM syCoesa_datos_tecnicos_laminas WHERE id_lamina=$id_registro;", $conexion);
...
//LAMINAS - VARIABLES
$laminas_id=$fila_laminas["id_lamina"];
$laminas_articulo=$fila_laminas["id_articulo"];
$laminas_ancho=$fila_laminas["ancho_lamina"];
$laminas_grm2=$fila_laminas["grm2_lamina"];
$laminas_calculokg=$fila_laminas["calculo_kg_lamina"];

//ARTICULOS
$rst_articulo=mysql_query("SELECT * FROM syCoesa_articulo WHERE id_tipo_articulo=3 ORDER BY nombre_articulo ASC;", $conexion);
    ...
    <section id="contenido">
        ...
        <div id="datos_laminas">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera"><h6>Datos Técnicos Láminas | ID: <?php echo $laminas_id; ?></h6></div>
                ...
                <div class="frmdt_contenido">
                  ...
                  <form action="actualizar.php" method="post">
                        ...
                        <fieldset class="alto50">
                            <label for="laminas_ancho">Ancho:</label>
                          <span id="spry_laminas_ancho">
                          <input name="laminas_ancho" type="text" class="an50" id="laminas_ancho" value="<?php echo $laminas_ancho; ?>" size="50">
                          <span class="textfieldRequiredMsg">(*)</span>
                          <span class="textfieldInvalidFormatMsg">(*)</span></span>
                        </fieldset>
                        
                        <fieldset class="alto50">
                            <label for="laminas_grm2">Gr x M2:</label>
                          <span id="spry_laminas_grm2">
                          <input name="laminas_grm2" type="text" class="an50" id="laminas_grm2" value="<?php echo $laminas_grm2; ?>" size="50">
                          <span class="textfieldRequiredMsg">(*)</span>
                          <span class="textfieldInvalidFormatMsg">(*)</span></span>
                        </fieldset>
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("spry_laminas_grm2", "real");
var sprytextfield3 = new Spry.Widget.ValidationTextField("spry_laminas_ancho", "real");
