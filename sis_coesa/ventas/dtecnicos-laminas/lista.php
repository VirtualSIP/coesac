...
//DATOS TECNICOS
$rst_laminas=mysql_query("SELECT * FROM syCoesa_datos_tecnicos_laminas ORDER BY id_lamina ASC;", $conexion);
        ...
        <div id="datos_laminas">
            ...
            <div class="formulario_datos">
              ...
              <div class="frmdt_cabecera">
                <h6>Datos Técnicos Láminas - Lista</h6></div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                    	...
                    	<?php while($fila_laminas=mysql_fetch_array($rst_laminas)){
							$lamina_id=$fila_laminas["id_lamina"];
